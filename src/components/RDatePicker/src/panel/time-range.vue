<template>
  <transition
    ...
    <div
      v-show="visible"
      class="r-time-range-picker r-picker-panel r-popper"
      :class="popperClass">
      <div class="r-time-range-picker__content">
        <div class="r-time-range-picker__cell">
          <div class="r-time-range-picker__header">{{ t('el.datepicker.startTime') }}</div>
          <div
            :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
            class="r-time-range-picker__body r-time-panel__content">
            <time-spinner
              ref="minSpinner"
        ...
        <div class="r-time-range-picker__cell">
          <div class="r-time-range-picker__header">{{ t('el.datepicker.endTime') }}</div>
          <div
            :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
            class="r-time-range-picker__body r-time-panel__content">
            <time-spinner
      ...
      <div class="r-time-panel__footer">
        <button
          type="button"
          class="r-time-panel__btn cancel"
          @click="handleCancel()">{{ t('el.datepicker.cancel') }}</button>
        <button
          type="button"
          class="r-time-panel__btn confirm"
          @click="handleConfirm()"
