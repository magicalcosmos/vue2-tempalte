<template>
  <transition name="r-zoom-in-top" @after-leave="$emit('dodestroy')">
    <div
      v-show="visible"
      class="r-time-panel r-popper"
      :class="popperClass">
      <div class="r-time-panel__content" :class="{ 'has-seconds': showSeconds }">
        <time-spinner
          ref="spinner"
          @change="handleChange"
...
import { limitTimeRange, isDate, clearMilliseconds, timeWithinRange } from '@/components/RSrc/utils/date-util';
