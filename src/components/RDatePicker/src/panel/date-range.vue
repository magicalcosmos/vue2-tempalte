<template>
  <transition name="r-zoom-in-top" @after-leave="$emit('dodestroy')">
    <div
      v-show="visible"
      class="r-picker-panel r-date-range-picker r-popper"
      :class="[{
        'has-sidebar': $slots.sidebar || shortcuts,
        'has-time': showTime
      }, popperClass]">
      <div class="r-picker-panel__body-wrapper">
        <slot name="sidebar" class="r-picker-panel__sidebar"></slot>
        <div class="r-picker-panel__sidebar" v-if="shortcuts">
          <button
            type="button"
            class="r-picker-panel__shortcut"
            v-for="(shortcut, key) in shortcuts"
            :key="key"
            @click="handleShortcutClick(shortcut)">{{shortcut.text}}</button>
        </div>
        <div class="r-picker-panel__body">
          <div class="r-date-range-picker__time-header" v-if="showTime">
            <span class="r-date-range-picker__editors-wrap">
              <span class="r-date-range-picker__time-picker-wrap">
                <r-input
                  size="small"
                  :disabled="rangeState.selecting"
                  ref="minInput"
                  :placeholder="t('el.datepicker.startDate')"
                  class="r-date-range-picker__editor"
                  :value="minVisibleDate"
                  @input="val => handleDateInput(val, 'min')"
                  @change="val => handleDateChange(val, 'min')" />
              </span>
              <span class="r-date-range-picker__time-picker-wrap" v-clickoutside="handleMinTimeClose">
                <r-input
                  size="small"
                  class="r-date-range-picker__editor"
                  :disabled="rangeState.selecting"
            ...
            <span class="r-icon-arrow-right"></span>
            <span class="r-date-range-picker__editors-wrap is-right">
              <span class="r-date-range-picker__time-picker-wrap">
                <r-input
                  size="small"
                  class="r-date-range-picker__editor"
              ...
              <span class="r-date-range-picker__time-picker-wrap" v-clickoutside="handleMaxTimeClose">
                <r-input
                  size="small"
                  class="r-date-range-picker__editor"
                  :disabled="rangeState.selecting"
          ...
          <div class="r-picker-panel__content r-date-range-picker__content is-left">
            <div class="r-date-range-picker__header">
              <button
                type="button"
                @click="leftPrevYear"
                class="r-picker-panel__icon-btn r-icon-d-arrow-left"></button>
              <button
                type="button"
                @click="leftPrevMonth"
                class="r-picker-panel__icon-btn r-icon-arrow-left"></button>
              <button
                type="button"
                @click="leftNextYear"
                v-if="unlinkPanels"
                ...
                class="r-picker-panel__icon-btn r-icon-d-arrow-right"></button>
              <button
                type="button"
                @click="leftNextMonth"
                v-if="unlinkPanels"
                ...
                class="r-picker-panel__icon-btn r-icon-arrow-right"></button>
              <div>{{ leftLabel }}</div>
            </div>
            <date-table
          ...
          <div class="r-picker-panel__content r-date-range-picker__content is-right">
            <div class="r-date-range-picker__header">
              <button
                type="button"
                @click="rightPrevYear"
      ...
      <div class="r-picker-panel__footer" v-if="showTime">
        <r-button
          size="mini"
          type="text"
          class="r-picker-panel__link-btn"
          @click="handleClear">
...
import {
  ...
  extractDateFormat,
  extractTimeFormat
} from '@/components/RSrc/utils/date-util';
...
export default {
  ...
  components: { TimePicker, DateTable, RInput, RButton }
};
</script>
