<template>
  <transition name="r-zoom-in-top" @after-enter="handleEnter" @after-leave="handleLeave">
    <div
      v-show="visible"
      class="r-picker-panel r-date-picker r-popper"
      :class="[{
      ...
      <div class="r-picker-panel__body-wrapper">
        ...
        <div class="r-picker-panel__body">
          <div class="r-date-picker__time-header" v-if="showTime">
            <span class="r-date-picker__editor-wrap">
              <r-input
            ...
            <span class="r-date-picker__editor-wrap" v-clickoutside="handleTimePickClose">
              <r-input
                ref="input"
          ...
          <div
            class="r-date-picker__header"
            :class="{ 'r-date-picker__header--bordered': currentView === 'year' || currentView === 'month' }"
            v-show="currentView !== 'time'">
            <button
              type="button"
              @click="prevYear"
              :aria-label="t(`el.datepicker.prevYear`)"
              class="r-picker-panel__icon-btn r-date-picker__prev-btn r-icon-d-arrow-left">
            </button>
            <button
              type="button"
              @click="prevMonth"
              ...
              class="r-picker-panel__icon-btn r-date-picker__prev-btn r-icon-arrow-left">
            </button>
            <span
              @click="showYearPicker"
              role="button"
              class="r-date-picker__header-label">{{ yearLabel }}</span>
            <span
              @click="showMonthPicker"
              v-show="currentView === 'date'"
              role="button"
              class="r-date-picker__header-label"
              :class="{ active: currentView === 'month' }">{{t(`el.datepicker.month${ month + 1 }`)}}</span>
            <button
              type="button"
              @click="nextYear"
              :aria-label="t(`el.datepicker.nextYear`)"
              class="r-picker-panel__icon-btn r-date-picker__next-btn r-icon-d-arrow-right">
            </button>
            <button
              type="button"
              @click="nextMonth"
              ...
              class="r-picker-panel__icon-btn r-date-picker__next-btn r-icon-arrow-right">
            </button>
          </div>

          <div class="r-picker-panel__content">
            <date-table
              v-show="currentView === 'date'"
              @pick="handleDatePick"
...
export default {
  ...
  components: {
    TimePicker, YearTable, MonthTable, DateTable, RInput, RButton
  },
