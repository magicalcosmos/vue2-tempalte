<template>
  <table @click="handleMonthTableClick" @mousemove="handleMouseMove" class="r-month-table">
    <tbody>
...
import { isDate, range, getDayCountOfMonth, nextDate } from '@/components/RSrc/utils/date-util';
import { hasClass } from '@/components/RSrc/utils/dom';
import { arrayFindIndex, coerceTruthyValueToArray, arrayFind } from '@/components/RSrc/utils/util';
