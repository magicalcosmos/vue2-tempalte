<template>
  <div class="r-time-spinner" :class="{ 'has-seconds': showSeconds }">
    <template v-if="!arrowControl">
      <r-scrollbar
        @mouseenter.native="emitSelectRange('hours')"
        @mousemove.native="adjustCurrentSpinner('hours')"
        class="r-time-spinner__wrapper"
        wrap-style="max-height: inherit;"
        view-class="r-time-spinner__list"
        noresize
        tag="ul"
        ref="hours">
        <li
    ...
    <template v-if="arrowControl">
      <div
        ...
        class="r-time-spinner__wrapper is-arrow">
        <i v-repeat-click="decrease" class="r-time-spinner__arrow r-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="r-time-spinner__arrow r-icon-arrow-down"></i>
        <ul class="r-time-spinner__list" ref="hours">
          <li
            class="r-time-spinner__item"
      ...
      <div
        ...
        <i v-repeat-click="decrease" class="r-time-spinner__arrow r-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="r-time-spinner__arrow r-icon-arrow-down"></i>
        <ul class="r-time-spinner__list" ref="minutes">
          <li
            class="r-time-spinner__item"
      ...
      <div
        ...
        <i v-repeat-click="decrease" class="r-time-spinner__arrow r-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="r-time-spinner__arrow r-icon-arrow-down"></i>
        <ul class="r-time-spinner__list" ref="seconds">
          <li
...
import { getRangeHours, getRangeMinutes, modifyTime } from '@/components/RSrc/utils/date-util';
import RScrollbar from '@/components/RScrollbar';
import RepeatClick from '@/components/RSrc/directives/repeat-click';
