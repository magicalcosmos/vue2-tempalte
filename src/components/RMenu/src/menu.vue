...
import Menubar from '@/components/RSrc/utils/menu/aria-menubar';
import { addClass, removeClass, hasClass } from '@/components/RSrc/utils/dom';
...
export default {
  ...
  render(h) {
    const component = (
      <ul
        ...
        class={{
          'r-menu--horizontal': this.mode === 'horizontal',
          'r-menu--collapse': this.collapse,
          "r-menu": true
        }}
      >
        { this.$slots.default }
        ...
        const data = {
          ...
          on: {
            ...
            beforeLeave(el) {
              ...
              if (hasClass(el, 'r-menu--collapse')) {
                removeClass(el, 'r-menu--collapse');
                el.dataset.oldOverflow = el.style.overflow;
                el.dataset.scrollWidth = el.clientWidth;
                addClass(el, 'r-menu--collapse');
              } else {
                addClass(el, 'r-menu--collapse');
                el.dataset.oldOverflow = el.style.overflow;
                el.dataset.scrollWidth = el.clientWidth;
  ...
  watch: {
    ...
    collapse(value) {
      ...
      this.broadcast('RSubmenu', 'toggle-collapse', value);
    }
  },
  methods: {
