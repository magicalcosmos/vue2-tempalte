...
import ReplaceFileOrFolder from '../../../../../src/views/components/Dialog/ReplaceFileOrFolder.vue';
...
const factory = options => {
  return mount(ReplaceFileOrFolder, {
    ...mountItem,
    ...options
  });
};

describe('Test ReplaceFileOrFolder', () => {
  beforeEach(() => {
    window['vm'].$i18n = i18n;
  });
  it('renders ReplaceFileOrFolder ', () => {
    const wrapper = factory();
    expect(wrapper.exists()).toBe(true);
    expect(wrapper.find('.file-dialog').isVisible()).toBe(false);
