...
import EditPointerTarget from '../../../../../src/views/components/Dialog/EditPointerTarget.vue';
...
const factory = options => {
  return shallowMount(EditPointerTarget, {
    ...mountItem,
    ...options
  });
};

describe('EditPointerTarget', () => {
  it('Test EditPointerTarget render', () => {
  ...
  describe('Test attributes', () => {
    it('Test title', () => {
      const wrapper = factory();
      expect(wrapper.attributes('title')).toBe(i18n.t('dialog.edit_malloc'));
      wrapper.destroy();
    });
    it('Test confirm', () => {
      const wrapper = factory();
  ...
  it('Test handleCancel', async() => {
    ...
    expect(wrapper.vm.constructorFunc).toBe('');
